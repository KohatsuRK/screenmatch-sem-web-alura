...
public class Principal {
    ...
    private final String API_KEY = "&apikey=9cea795f";
    ...
    public void exibeMenu() {
        ...
        while (opcao != 0) {
            var menu = """
                    1 - Buscar séries
                    2 - Buscar episódios
                    3 - Listar Séries busacadas
                    4 - Buscar séries por Título
                    5 - Buscar séries por ator
                    6 - Top 5 séries
                    7 - Buscar sérires por Categoria
                    8 - Filtrar séries
                    9 - Buscar por episódio
                    10 - Top 5 epsódios por série
                    11 - Buscar epsódios a partir de uma data
...
//                .findFirst();
        //aqui esta busscando direto do banco, sem precisar trazer ele inteiro para ca
    ...
    private void buscarSeriePorAtor() {
        ...
        seriesEncontradas.forEach(s->
                System.out.println(s.getTitulo() + " Avalicação: " + s.getAvaliacao()));
    }
    ...
    private void buscarSereiPorCategoria() {
